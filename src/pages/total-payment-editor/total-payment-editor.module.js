...
import { TotalPaymentEditorPage } from './total-payment-editor';
var TotalPaymentEditorPageModule = /** @class */ (function () {
    function TotalPaymentEditorPageModule() {
    }
    TotalPaymentEditorPageModule = __decorate([
        NgModule({
            imports: [
                IonicPageModule.forChild(TotalPaymentEditorPage),
            ],
        })
    ], TotalPaymentEditorPageModule);
    return TotalPaymentEditorPageModule;
}());
export { TotalPaymentEditorPageModule };
